                ...
                <div className="section footer-top">
                  <div className="footer-brand">
                    <a href="#" className="logo">
                      <img src={Myimage} width="119" height="37" loading="la" alt="Wren logo"/>
                    </a>
                  ...
                  <div className="footer-list">
                    ...
                    <div className="input-wrapper">
                      <input type="email" name="email_address" placeholder="Emaill address" required className="input-field" autocomplete="off"/>
